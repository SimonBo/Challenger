...
(function() {
  ...
  NotificationPoller = {
    poll: function() {
      return setTimeout(this.request, 20000);
    },
    request: function() {
...
(function() {
  ...
  bet = {
    setupForm: function() {
      ...
      return $('#new_dare').submit(function() {
    ...
    processCard: function() {
      ...
      return Stripe.createToken(card, bet.handleStripeResponse);
    },
...
(function() {
  jQuery(function() {
    if ($('#accordion').length > 0) {
      return $('.collapse:not(:has(a))').each(function() {
