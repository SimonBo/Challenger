...
(function() {
  ...
  NotificationPoller = {
    poll: function() {
      return setTimeout(this.request, 30000);
    },
    cleanup: function() {
      $('.user_panel.collapsed:has(a)').each(function() {
        return $(this).removeClass('collapsed').collapse('show');
      });
      return $('.user_panel.collapse:not(:has(a))').each(function() {
        if (!$(this).hasClass('collapsed')) {
          return $(this).addClass('collapsed').collapse('hide');
        }
      });
    },
    request: function() {
      ...
      return NotificationPoller.poll();
    }
  };
...
(function() {
  jQuery(function() {
    ...
    return $('#fb_post').click(function(e) {
      var user_token;
      ...
      return FB.api("/me/feed?", "post", {
        ...
        if (!response || response.error) {
          ...
          return alert("Message successfully posted to your wall");
        }
      });
    });
  });
...
//   js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&appId=1501467833473137&version=v2.0";
...
(function() {
  $(function() {
    $("a[href*=#]:not([href=#])").click(function() {
      var target;
      if ($(this).attr('data-parent') !== "#select_acceptor") {
...
(function() {
  jQuery(function() {
    return $(document).on('click', '.sort_link', function() {
      var self, sort;
      sort = $(this).attr('href');
      ...
      return $('#challenges').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function() {
